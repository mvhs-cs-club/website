...
const CustomFadeIn = (props: any) => <FadeIn {...props} length={0.65} />
				...
				: user !== null
					? (
						<ActionPanelWrapper>
								...
								contractNewProblem
									? (
										<FadeOut sx={fullWidthSx} length={0.4}>
											<ExpandUp
												callback={handleNewProblemCallback}
											>
												<NewProblemEl />
											</ExpandUp>
										</FadeOut>
							...
							<PageTitle
								sx={{ marginTop: contractNewProblem ? 4 : 0 }}
							>
								Action Panel
							</PageTitle>
							<CardWrapper>
							...
							>
								<DialogTitle>
									{"Are you sure you want to delete your data? There is no going back"}
								</DialogTitle>
								<DialogActions>
									<Button
